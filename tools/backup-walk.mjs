...
async function main() {
  ...
  const strip = (o) => ({
    spools: o.spools, models: o.models, jobs: o.jobs,
  });
  ...
  if (before !== after) {
    ...
    pass(`export -> wipe -> import -> export is byte-identical across ${a.jobs.length} jobs, ${a.spools.length} spools, ${a.models.length} models`);
  }
